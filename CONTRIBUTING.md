...
Every action to make project horizon better is encouraged. On GitHub, every improvement for horizon could be via a [PR](https://github.com/horizon/pulls) (short for pull request).
