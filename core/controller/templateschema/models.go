...
import (
	...
	clustertagmodels "g.hz.netease.com/horizon/pkg/templateschema/models"
)
...
func (r *UpdateRequest) toClusterTags(clusterID uint, user user.User) []*clustertagmodels.ClusterTemplateSchemaTag {
...
func ofClusterTags(clusterTemplateSchemaTags []*clustertagmodels.ClusterTemplateSchemaTag) *ListResponse {
	return &ListResponse{
		Tags: func() []*Tag {
