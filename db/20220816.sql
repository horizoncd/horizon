...
(
    ...
    `failed_reason`  varchar(2048)       NOT NULL DEFAULT '' COMMENT 'failed reason for last syncing',
    `commit_id`      varchar(246)        NOT NULL DEFAULT '' COMMENT 'commit id for last syncing',
