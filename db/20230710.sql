...
(
    ...
    `image`            varchar(256)                 DEFAULT NULL COMMENT 'artifact image url',
...
(
    ...
    `code`         varchar(256)        NOT NULL DEFAULT '' COMMENT 'private-token-code/authorize_code/access_token/refresh_token',
    `created_at`   datetime            NOT NULL DEFAULT CURRENT_TIMESTAMP,
