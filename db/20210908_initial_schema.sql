...
(
    ...
    `traversal_ids`    varchar(32)  NOT NULL DEFAULT '''' COMMENT '' ID path from the root,
    like 1, 2, 3 '',
...
(
    ...
    `oidc_id`    varchar(64) NOT NULL COMMENT '' oidc id,
    which is a unique key in oidc system.'',
    `oidc_type`  varchar(64) NOT NULL COMMENT '' oidc type,
    such as netease,
    github,
    gitlab       etc.'',
...
(
    ...
    `recommended`    tinyint(1) NOT NULL COMMENT '' is the most recommended template, 0
    -
    false, 1
    -
    true
...
(
    ...
    `member_type`   tinyint(1) COMMENT '' 0- USER, 1
    -
    group
    '',
