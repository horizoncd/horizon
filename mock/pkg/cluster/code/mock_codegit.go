...
func (m *MockGitGetter) GetCommit(ctx context.Context, gitURL string, branch, commit *string) (*code.Commit, error) {
	m.ctrl.T.Helper()
...
func (mr *MockGitGetterMockRecorder) GetCommit(ctx, gitURL, branch, commit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCommit", reflect.TypeOf((*MockGitGetter)(nil).GetCommit), ctx, gitURL, branch, commit)
}
