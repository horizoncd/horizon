...
func (m *MockCD) Exec(ctx context.Context, params *cd.ExecParams) (map[string]cd.ExecResp, error) {
	m.ctrl.T.Helper()
...
// GetClusterStateV2 indicates an expected call of GetClusterStateV2.
func (mr *MockCDMockRecorder) GetClusterStateV2(ctx, params interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClusterStateV2", reflect.TypeOf((*MockCD)(nil).GetClusterStateV2), ctx, params)
}
