...
// Source: pkg/dao/templatedao/manager.go
...
import (
	context "context"
	templatedao "g.hz.netease.com/horizon/pkg/dao/template"
...
func (m *MockManager) Create(ctx context.Context, template *templatedao.Template) (*templatedao.Template, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, template)
	ret0, _ := ret[0].(*templatedao.Template)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockManager) List(ctx context.Context) ([]templatedao.Template, error) {
	m.ctrl.T.Helper()
