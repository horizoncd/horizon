...
// Source: pkg/dao/gitlabdao/manager.go
...
import (
	context "context"
	gitlabdao "g.hz.netease.com/horizon/pkg/dao/gitlab"
...
func (m *MockManager) Create(ctx context.Context, gitlab *gitlabdao.Gitlab) (*gitlabdao.Gitlab, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, gitlab)
	ret0, _ := ret[0].(*gitlabdao.Gitlab)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockManager) List(ctx context.Context) ([]gitlabdao.Gitlab, error) {
	m.ctrl.T.Helper()
...
func (m *MockManager) GetByName(ctx context.Context, name string) (*gitlabdao.Gitlab, error) {
	m.ctrl.T.Helper()
