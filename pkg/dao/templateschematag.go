...
type TemplateSchemaTagDAO interface {
...
type templateSchemaTagDAO struct {
	db *gorm.DB
}

func NewTemplateSchemaTagDAO(db *gorm.DB) TemplateSchemaTagDAO {
	return &templateSchemaTagDAO{db: db}
}

func (d templateSchemaTagDAO) ListByClusterID(ctx context.Context,
...
func (d templateSchemaTagDAO) UpsertByClusterID(ctx context.Context,
	clusterID uint, tags []*models.ClusterTemplateSchemaTag) error {
