...
// NewUserDAO returns an instance of the default UserDAO
...
func (d *userDAO) Create(ctx context.Context, user *models.User) (*models.User, error) {
...
func (d *userDAO) List(ctx context.Context, query *q.Query) (int64, []*models.User, error) {
...
func (d *userDAO) GetByIDs(ctx context.Context, userID []uint) ([]*models.User, error) {
	var users []*models.User
...
func (d *userDAO) GetByOIDCMeta(ctx context.Context, oidcType, email string) (*models.User, error) {
...
func (d *userDAO) ListByEmail(ctx context.Context, emails []string) ([]*models.User, error) {
	if len(emails) == 0 {
		return nil, nil
	}
...
func (d *userDAO) UpdateByID(ctx context.Context, id uint, newUser *models.User) (*models.User, error) {
	var user *models.User
	err := d.db.
		Transaction(
...
func (d *userDAO) GetUserByIDP(ctx context.Context, email string, idp string) (*models.User, error) {
	var u *models.User
...
func (d *userDAO) DeleteUser(ctx context.Context, id uint) error {
