...
func (d tagDAO) ListByResourceTypeID(ctx context.Context, resourceType string, resourceID uint) ([]*models.Tag, error) {
	var tags []*models.Tag
...
func (d tagDAO) ListByResourceTypeIDs(ctx context.Context, resourceType string,
...
func (d tagDAO) UpsertByResourceTypeID(ctx context.Context, resourceType string,
...
func (d tagDAO) CreateMetatags(ctx context.Context, metatags []*models.Metatag) error {
...
func (d tagDAO) GetMetatagsByKey(ctx context.Context, key string) ([]*models.Metatag, error) {
...
func (d tagDAO) GetMetatagKeys(ctx context.Context) ([]string, error) {
	var keys []string
