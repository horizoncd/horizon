...
// NewWebhookDAO returns an instance of the default WebhookDAO
func NewWebhookDAO(db *gorm.DB) WebhookDAO {
	return &webhookDAO{db: db}
}

func (d *webhookDAO) CreateWebhook(ctx context.Context, webhook *models.Webhook) (*models.Webhook, error) {
...
func (d *webhookDAO) GetWebhook(ctx context.Context, id uint) (*models.Webhook, error) {
...
func (d *webhookDAO) ListWebhooks(ctx context.Context) ([]*models.Webhook, error) {
...
func (d *webhookDAO) ListWebhookOfResources(ctx context.Context,
	resources map[string][]uint, query *q.Query) ([]*models.Webhook, int64, error) {
	var ws []*models.Webhook
	var (
		condition *gorm.DB
...
func (d *webhookDAO) UpdateWebhook(ctx context.Context, id uint,
...
func (d *webhookDAO) DeleteWebhook(ctx context.Context, id uint) error {
...
func (d *webhookDAO) CreateWebhookLog(ctx context.Context,
...
func (d *webhookDAO) CreateWebhookLogs(ctx context.Context,
...
func (d *webhookDAO) ListWebhookLogs(ctx context.Context, query *q.Query,
	resources map[string][]uint) ([]*models.WebhookLogWithEventInfo, int64, error) {
	var (
...
func (d *webhookDAO) ListWebhookLogsByMap(ctx context.Context,
	webhookEventMap map[uint][]uint) ([]*models.WebhookLog, error) {
	var (
...
func (d *webhookDAO) ListWebhookLogsByStatus(ctx context.Context, wID uint,
	status string) ([]*models.WebhookLog, error) {
...
func (d *webhookDAO) UpdateWebhookLog(ctx context.Context, wl *models.WebhookLog) (*models.WebhookLog, error) {
...
func (d *webhookDAO) GetWebhookLog(ctx context.Context, id uint) (*models.WebhookLog, error) {
...
func (d *webhookDAO) GetWebhookLogByEventID(ctx context.Context, webhookID, eventID uint) (*models.WebhookLog, error) {
	var wl models.WebhookLog
...
func (d *webhookDAO) DeleteWebhookLogs(ctx context.Context, ids ...uint) (int64, error) {
...
func (d *webhookDAO) GetMaxEventIDOfLog(ctx context.Context) (uint, error) {
	var maxID uint
