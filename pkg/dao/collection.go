...
func (d collectionDAO) Create(ctx context.Context, collection *models.Collection) (*models.Collection, error) {
...
func (d collectionDAO) GetByResource(ctx context.Context, userID uint, resourceID uint,
	resourceType string) (*models.Collection, error) {
...
func (d collectionDAO) DeleteByResource(ctx context.Context, userID uint, resourceID uint,
	resourceType string) (*models.Collection, error) {
	collection := models.Collection{}
	result := d.db.WithContext(ctx).Where("user_id = ?", userID).
		Where("resource_id = ?", resourceID).
...
func (d collectionDAO) List(ctx context.Context, userID uint, resourceType string,
