...
type ClusterDAO interface {
	Create(ctx context.Context, cluster *models.Cluster,
		tags []*models.Tag, extraMembers map[*models.User]string) (*models.Cluster, error)
...
func NewClusterDAO(db *gorm.DB) ClusterDAO {
	return &clusterDAO{db: db}
}

func (d *clusterDAO) Create(ctx context.Context, cluster *models.Cluster,
	tags []*models.Tag, extraMembers map[*models.User]string) (*models.Cluster, error) {
...
func (d *clusterDAO) GetByID(ctx context.Context, id uint, includeSoftDelete bool) (*models.Cluster, error) {
...
func (d *clusterDAO) GetByName(ctx context.Context, clusterName string) (*models.Cluster, error) {
	var cluster models.Cluster
...
func (d *clusterDAO) UpdateByID(ctx context.Context, id uint, cluster *models.Cluster) (*models.Cluster, error) {
...
func (d *clusterDAO) DeleteByID(ctx context.Context, id uint) error {
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return err
	}
...
func (d *clusterDAO) CheckClusterExists(ctx context.Context, cluster string) (bool, error) {
...
func (d *clusterDAO) List(ctx context.Context, query *q.Query, userID uint,
	withRegion bool, appIDs ...uint) (int, []*models.ClusterWithRegion, error) {
	var (
	...
	genSQL := func(statement *gorm.DB, query *q.Query) *gorm.DB {
		for k, v := range query.Keywords {
			...
			case common.ClusterQueryTagSelector:
				if tagSelectors, ok := v.([]models.TagSelector); ok {
...
func GenSQLForTagSelector(tagSelectors []models.TagSelector, statement *gorm.DB) *gorm.DB {
...
func (d *clusterDAO) ListClusterWithExpiry(ctx context.Context,
...
func (d *clusterDAO) GetByNameFuzzily(ctx context.Context,
	name string, includeSoftDelete bool) ([]*models.Cluster, error) {
	var clusters []*models.Cluster
