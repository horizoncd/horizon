...
// NewGroupDAO returns an instance of the default GroupDAO
func NewGroupDAO(db *gorm.DB) GroupDAO {
	return &groupDAO{db: db}
}

type groupDAO struct{ db *gorm.DB }

func (d *groupDAO) UpdateRegionSelector(ctx context.Context, id uint, regionSelector string) error {
...
func (d *groupDAO) GetByIDNameFuzzily(ctx context.Context, id uint, name string) ([]*models.Group, error) {
...
func (d *groupDAO) ListChildren(ctx context.Context, parentID uint, pageNumber, pageSize int) (
...
func (d *groupDAO) Transfer(ctx context.Context, id, newParentID uint) error {
...
func (d *groupDAO) CountByParentID(ctx context.Context, parentID uint) (int64, error) {
	var count int64
...
func (d *groupDAO) GetByPaths(ctx context.Context, paths []string) ([]*models.Group, error) {
	var groups []*models.Group
...
func (d *groupDAO) GetByIDs(ctx context.Context, ids []uint) ([]*models.Group, error) {
	var groups []*models.Group
...
func (d *groupDAO) GetAll(ctx context.Context) ([]*models.Group, error) {
	var groups []*models.Group
	result := d.db.WithContext(ctx).Raw(dbcommon.GroupAll).Scan(&groups)
	return groups, result.Error
}

func (d *groupDAO) CheckPathUnique(ctx context.Context, group *models.Group) error {
	queryResult := models.Group{}
...
func (d *groupDAO) GetByNameFuzzily(ctx context.Context, name string, includeSoftDelete bool) ([]*models.Group, error) {
	var groups []*models.Group
...
func (d *groupDAO) CheckNameUnique(ctx context.Context, group *models.Group) error {
...
func (d *groupDAO) Create(ctx context.Context, group *models.Group) (*models.Group, error) {
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (d *groupDAO) Delete(ctx context.Context, id uint) (int64, error) {
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return 0, err
	}
...
func (d *groupDAO) GetByID(ctx context.Context, id uint) (*models.Group, error) {
...
func (d *groupDAO) ListWithoutPage(ctx context.Context, query *q.Query) ([]*models.Group, error) {
	var groups []*models.Group
...
func (d *groupDAO) List(ctx context.Context, query *q.Query) ([]*models.Group, int64, error) {
	var groups []*models.Group
...
func (d *groupDAO) UpdateBasic(ctx context.Context, group *models.Group) error {
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return err
	}
...
func (d *groupDAO) GetByNameOrPathUnderParent(ctx context.Context,
...
func (d *groupDAO) ListByTraversalIDsContains(ctx context.Context, ids []uint) ([]*models.Group, error) {
	if len(ids) == 0 {
		return nil, nil
	}
	var groups []*models.Group
