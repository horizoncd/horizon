...
import (
	...
	accessctl "github.com/horizoncd/horizon/pkg/core/controller/access"
	accesstokenctl "github.com/horizoncd/horizon/pkg/core/controller/accesstoken"
	applicationctl "github.com/horizoncd/horizon/pkg/core/controller/application"
	applicationregionctl "github.com/horizoncd/horizon/pkg/core/controller/applicationregion"
	"github.com/horizoncd/horizon/pkg/core/controller/build"
	clusterctl "github.com/horizoncd/horizon/pkg/core/controller/cluster"
	codectl "github.com/horizoncd/horizon/pkg/core/controller/code"
	environmentctl "github.com/horizoncd/horizon/pkg/core/controller/environment"
	environmentregionctl "github.com/horizoncd/horizon/pkg/core/controller/environmentregion"
	envtemplatectl "github.com/horizoncd/horizon/pkg/core/controller/envtemplate"
	eventctl "github.com/horizoncd/horizon/pkg/core/controller/event"
	groupctl "github.com/horizoncd/horizon/pkg/core/controller/group"
	idpctl "github.com/horizoncd/horizon/pkg/core/controller/idp"
	memberctl "github.com/horizoncd/horizon/pkg/core/controller/member"
	oauthservicectl "github.com/horizoncd/horizon/pkg/core/controller/oauth"
	oauthappctl "github.com/horizoncd/horizon/pkg/core/controller/oauthapp"
	oauthcheckctl "github.com/horizoncd/horizon/pkg/core/controller/oauthcheck"
	prctl "github.com/horizoncd/horizon/pkg/core/controller/pipelinerun"
	regionctl "github.com/horizoncd/horizon/pkg/core/controller/region"
	registryctl "github.com/horizoncd/horizon/pkg/core/controller/registry"
	roltctl "github.com/horizoncd/horizon/pkg/core/controller/role"
	scopectl "github.com/horizoncd/horizon/pkg/core/controller/scope"
	tagctl "github.com/horizoncd/horizon/pkg/core/controller/tag"
	...
	terminalctl "github.com/horizoncd/horizon/pkg/core/controller/terminal"
	userctl "github.com/horizoncd/horizon/pkg/core/controller/user"
	webhookctl "github.com/horizoncd/horizon/pkg/core/controller/webhook"
	accessapi "github.com/horizoncd/horizon/pkg/core/http/api/v1/access"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/accesstoken"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/application"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/applicationregion"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/cluster"
	codeapi "github.com/horizoncd/horizon/pkg/core/http/api/v1/code"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/environment"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/environmentregion"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/envtemplate"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/event"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/group"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/idp"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/member"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/oauthapp"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/oauthserver"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/pipelinerun"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/region"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/registry"
	roleapi "github.com/horizoncd/horizon/pkg/core/http/api/v1/role"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/scope"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/tag"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/template"
	accessv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/access"
	accesstokenv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/accesstoken"
	applicationregionv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/applicationregion"
	codev2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/code"
	environmentv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/environment"
	environmentregionv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/environmentregion"
	eventv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/event"
	groupv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/group"
	idpv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/idp"
	memberv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/member"
	oauthappv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/oauthapp"
	pipelinerunv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/pipelinerun"
	regionv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/region"
	registryv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/registry"
	rolev2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/role"
	scopev2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/scope"
	tagv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/tag"
	templateschematagv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/templateschematag"
	terminalv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/terminal"
	userv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/user"
	webhookv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/webhook"
	"github.com/horizoncd/horizon/pkg/core/middleware"
	"github.com/horizoncd/horizon/pkg/core/middleware/auth"
	...
	templateschematagapi "github.com/horizoncd/horizon/pkg/core/http/api/v1/templateschematag"
	terminalapi "github.com/horizoncd/horizon/pkg/core/http/api/v1/terminal"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/user"
	"github.com/horizoncd/horizon/pkg/core/http/api/v1/webhook"
	appv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/application"
	buildAPI "github.com/horizoncd/horizon/pkg/core/http/api/v2/build"
	envtemplatev2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/envtemplate"
	templatev2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/template"
	"github.com/horizoncd/horizon/pkg/core/http/health"
	"github.com/horizoncd/horizon/pkg/core/http/metrics"
	ginlogmiddle "github.com/horizoncd/horizon/pkg/core/middleware/ginlog"
	logmiddle "github.com/horizoncd/horizon/pkg/core/middleware/log"
	metricsmiddle "github.com/horizoncd/horizon/pkg/core/middleware/metrics"
	prehandlemiddle "github.com/horizoncd/horizon/pkg/core/middleware/prehandle"
	regionmiddle "github.com/horizoncd/horizon/pkg/core/middleware/region"
	tagmiddle "github.com/horizoncd/horizon/pkg/core/middleware/tag"
	tokenmiddle "github.com/horizoncd/horizon/pkg/core/middleware/token"
	usermiddle "github.com/horizoncd/horizon/pkg/core/middleware/user"
	...
	clusterv2 "github.com/horizoncd/horizon/pkg/core/http/api/v2/cluster"
