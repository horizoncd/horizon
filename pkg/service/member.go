...
type MemberService interface {
	...
	CreateMember(ctx context.Context, postMember models.PostMember) (*models.Member, error)
...
func NewMemberService(roleService roleservice.Service, oauthManager manager.OAuthManager,
	manager *managerparam.Manager) MemberService {
...
func (s *memberService) RequirePermissionEqualOrHigher(ctx context.Context, role,
...
func (s *memberService) CreateMember(ctx context.Context, postMember models.PostMember) (*models.Member, error) {
	...
	// 3. do create  member
	member, err := models.ConvertPostMemberToMember(postMember, currentUser)
	if err != nil {
		return nil, err
	}
...
func (s *memberService) getOauthAppMember(ctx context.Context, clientID string) (*models.Member, error) {
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (s *memberService) getPipelinerunMember(ctx context.Context, pipelinerunID uint) (*models.Member, error) {
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (s *memberService) listPipelinerunMember(ctx context.Context, pipelinerunID uint) ([]models.Member, error) {
	pipeline, err := s.pipelineManager.GetByID(ctx, pipelinerunID)
	if err != nil {
		return nil, err
	}
...
func (s *memberService) listWebhookMember(ctx context.Context, id uint) ([]models.Member, error) {
	if id == 0 {
		return nil, nil
	}
...
func (s *memberService) listWebhookLogMember(ctx context.Context, id uint) ([]models.Member, error) {
	if id == 0 {
		return nil, nil
	}
...
func (s *memberService) GetMemberOfResource(ctx context.Context,
...
func (s *memberService) GetMember(ctx context.Context, memberID uint) (*models.Member, error) {
	return s.memberManager.GetByID(ctx, memberID)
}

func (s *memberService) RemoveMember(ctx context.Context, memberID uint) error {
	// 1. get member
	...
	if user.UserType != models.UserTypeCommon {
...
func (s *memberService) UpdateMember(ctx context.Context, memberID uint, role string) (*models.Member, error) {
	// 1. get the member
	memberItem, err := s.memberManager.GetByID(ctx, memberID)
	if err != nil {
		return nil, err
...
func (s *memberService) ListMember(ctx context.Context, resourceType string, resourceID uint) ([]models.Member, error) {
	// get all the members
...
func (s *memberService) getMember(ctx context.Context, resourceType string, resourceID uint,
...
func (s *memberService) listGroupMembers(ctx context.Context, resourceID uint) ([]models.Member, error) {
	var (
	...
	groupIDs := manager.FormatIDsFromTraversalIDs(groupInfo.TraversalIDs)

	// 2. get all the direct memberService of group
...
func (s *memberService) listApplicationMembers(ctx context.Context, resourceID uint) ([]models.Member, error) {
	var (
		retMembers []models.Member
		members    []models.Member
		err        error
	...
	if directMemberOnly, ok := ctx.Value(memberctx.MemberDirectMemberOnly).(bool); !ok || !directMemberOnly {
		// 1. query the application's memberService
		applicationInfo, err := s.applicationManager.GetByID(ctx, resourceID)
		if err != nil {
			return nil, err
		}

		// 2. query the group's memberService
...
func (s *memberService) listApplicationInstanceMembers(ctx context.Context, resourceID uint) ([]models.Member, error) {
	var (
		retMembers []models.Member
		err        error
	)
...
func (s *memberService) createMemberDirect(ctx context.Context, postMember models.PostMember) (*models.Member, error) {
	var currentUser userauth.User
	currentUser, err := common.UserFromContext(ctx)
	if err != nil {
		return nil, err
...
func (s *memberService) listTemplateMembers(ctx context.Context, resourceID uint) ([]models.Member, error) {
	var (
		retMembers []models.Member
		members    []models.Member
		err        error
...
func (s *memberService) listReleaseMembers(ctx context.Context, id uint) ([]models.Member, error) {
