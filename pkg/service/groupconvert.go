...
func GenerateFullFromGroups(groups []*models.Group) *models.Full {
...
func ConvertGroupToChild(group *models.Group, full *models.Full) *models.Child {
	return &models.Child{
		ID:              group.ID,
		Name:            group.Name,
		Path:            group.Path,
...
func ConvertGroupOrApplicationToChild(groupOrApplication *models.GroupOrApplication, full *models.Full) *models.Child {
	return &models.Child{
...
func ConvertTemplateToChild(template *models.Template, full *models.Full) *models.Child {
	return &models.Child{
		ID:          template.ID,
		Name:        template.Name,
		Path:        template.Name,
...
func ConvertReleaseToChild(release *models.TemplateRelease, full *models.Full) *models.Child {
	return &models.Child{
		ID:          release.ID,
		Name:        release.Name,
		Path:        release.Name,
...
func ConvertApplicationToChild(app *models.Application, full *models.Full) *models.Child {
	return &models.Child{
		ID:          app.ID,
		Name:        app.Name,
		Path:        app.Name,
...
func ConvertClusterToChild(cluster *models.Cluster, full *models.Full) *models.Child {
	return &models.Child{
		ID:          cluster.ID,
		Name:        cluster.Name,
		Path:        cluster.Name,
...
*/
func GenerateIDToFull(groups []*models.Group) map[uint]*models.Full {
	// sort groups by the size of the traversalIDs array after split by ','
	sort.Sort(models.Groups(groups))

	idToFull := make(map[uint]*models.Full)
